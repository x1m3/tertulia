...
func With(args ...any) {
	slog.SetDefault(slog.With(args...))
}

// Debug logs a debug message  using context logger
func Debug(ctx context.Context, msg string, args ...any) {
	slog.With("req-id", middleware.GetReqID(ctx)).DebugContext(ctx, msg, args...)
}

// Info logs an info using context logger
func Info(ctx context.Context, msg string, args ...any) {
	slog.With("req-id", middleware.GetReqID(ctx)).InfoContext(ctx, msg, args...)
}

// Warn logs a warning using context logger
func Warn(ctx context.Context, msg string, args ...any) {
	slog.With("req-id", middleware.GetReqID(ctx)).WarnContext(ctx, msg, args...)
}

// Error logs an error using context logger
func Error(ctx context.Context, msg string, args ...any) {
	slog.With("req-id", middleware.GetReqID(ctx)).ErrorContext(ctx, msg, args...)
}
